...
import { CREATE_TRANSACTION } from "C:/Users/USER/OneDrive/Desktop/redo/frontend/graphql/mutations/transaction.mutation.js";
import toast from "react-hot-toast";

const TransactionForm = () => {
    // Mutation to create a new transaction
    const [createTransaction, { loading }] = useMutation(CREATE_TRANSACTION, {
        refetchQueries: ["GetTransactions", "GetTransactionStatistics"], // Refetch queries to update transaction data and statistics
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            form.reset();
            toast.success("Transaction created successfully"); // Show a success toast notification
        } catch (error) {
            toast.error(error.message); // Show an error toast notification if there was a problem
        }
    };
    ...
    return (
        <form className='w-full max-w-lg flex flex-col gap-5 px-3' onSubmit={handleSubmit}>
            ...
            {/* Payment type and category inputs */}
            ...
            >
                {loading ? "Loading..." : "Add Transaction"} {/* Show appropriate button text based on loading state */}
            </button>
        </form>
    );
};
